...
export const generateMessageIDV2 = (userId) => {
    ...
    return 'AXYLO' + hash.toString('hex').toUpperCase().substring(0, 18);
};
// generate a random ID to attach to a message
export const generateMessageID = () => 'AXYLO' + randomBytes(18).toString('hex').toUpperCase();
...
/**
 * Generates a pairing code based on "TESLANOTH" with random leetspeak substitutions.
 */
